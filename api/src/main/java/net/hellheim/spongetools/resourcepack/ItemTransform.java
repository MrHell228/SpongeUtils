...
public record ItemTransform(Map<ItemDisplayType, Transform> transforms) {
	
	public static final ItemTransform DEFAULT = new ItemTransform(Map.of());
	
	public static final Codec<ItemTransform> CODEC =
			Codec.unboundedMap(StringRepresentableCodecs.ITEM_DISPLAY_TYPE, MathCodecs.TRANSFORM)
			.xmap(ItemTransform::new, ItemTransform::transforms);
	
	public ItemTransform(final Map<ItemDisplayType, Transform> transforms) {
	...
	public static class Builder implements
			org.spongepowered.api.util.Builder<ItemTransform, Builder>,
			CopyableBuilder<ItemTransform, Builder> {
		...
		@Override
		public Builder from(final ItemTransform value) {
			this.reset();
		...
		public ItemTransform build() {
			return new ItemTransform(this.transforms);
		}
	}
}
